...
interface Product {
  ...
  exclusive: boolean;
  negotiable: boolean;
  seller: { name: string; membershipTier: string | null; role: string };
}
...
export default function ProductDetail({
  ...
  const sellerDisplay =
    context === "vault"
      ? "Curated by ZÖAR"
      : product.seller?.membershipTier?.replace("_", " ") || "Member Seller";
          ...
          <div className="fade-up">
            ...
            >
              ...
              <div>
                ...
                <p style={{ fontSize: 16, color: "var(--cream)" }}>{sellerDisplay}</p>
              </div>
              <div>
