    ...
    <div style={{ maxWidth: 1200, margin: "0 auto", padding: "48px 32px 120px" }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 48 }}>
        <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
          <ZoarLogo size={36} color="var(--gold)" />
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 16, marginBottom: 48 }}>
        {[
          ...
          { label: "Pending Applications", value: stats.applications, color: "var(--gold)" },
        ].map((s, i) => (
              ...
              >
                ...
                <span
                  style={{
                    ...
                    padding: "4px 12px",
                    border: `1px solid ${app.status === "PENDING" ? "var(--gold)" : app.status === "APPROVED" ? "#2d6a4f" : "var(--danger)"}`,
                    color: app.status === "PENDING" ? "var(--gold)" : app.status === "APPROVED" ? "#2d6a4f" : "var(--danger)",
                  }}
                >
                  {app.status}
                </span>
